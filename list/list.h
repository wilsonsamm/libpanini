...
/* Undefine this token if you want to leave out bounds checking in the functions
 * list_get_token and list_get_list. This speeds the program up. But you might
 * like to keep bounds checking if you are debugging. In that case, if something
 * tries to access something outside the range of the list, those functions will
